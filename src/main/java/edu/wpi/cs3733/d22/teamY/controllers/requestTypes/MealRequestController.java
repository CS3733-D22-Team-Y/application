...
public class MealRequestController {
	// Text input
	@FXML
	private TextField input_RoomID;
	@FXML
	private TextField input_PatientName;
	@FXML
	private TextArea input_AdditionalNotes;
	@FXML
	private TextField input_AssignedNurse;
	@FXML
	private TextField input_RequestStatus;

	@FXML
	private TextArea input_SpecialInstructions;
	// Radio button main course
	@FXML
	private JFXRadioButton pizzaRadioButton;
	@FXML
	private JFXRadioButton burgerRadioButton;
	@FXML
	private JFXRadioButton saladRadioButton;
	// Radio button sides
	@FXML
	private JFXRadioButton riceRadioButton;
	@FXML
	private JFXRadioButton peasRadioButton;
	@FXML
	private JFXRadioButton appleRadioButton;
	// Dropdown menu
	@FXML
	private JFXComboBox<String> dietaryRestrictionsSelectionBox;
	// Error Label
	@FXML

...
public class WelcomePageController {
	...
	@FXML
	private Pane failedLoginPane;
	@FXML
	private Label attemptsRemaining;
	@FXML
	...
	Pane yubikeyPane;
	@FXML
	TextField yubikeyEntry;
	@FXML
	Label yubikeyInstruct;
	@FXML
	Pane faYubikeyPane;
	@FXML
	Pane faPane;
	@FXML
	JFXButton faYubikeyButton;
	@FXML
	TextField codeEntryField;
	@FXML
	Pane codeEntryPane;
	@FXML
	Pane faPushPane;
	@FXML
	JFXButton faPushButton;
	@FXML
	Pane faEmailPane;
	@FXML
	JFXButton faEmailButton;
	@FXML
	Pane faSmsPane;
	@FXML
	JFXButton faSmsButton;
	@FXML
	Label codeEntryLabel;
